...
impl Display for InterCode {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::TESTSET(ra, rb, k) => write!(f, "TESTSET\t${} ${} {}", ra, rb, k),
            ...
            Self::GETUPVAL(ra, rb) => write!(f, "GETUPVAL\t${} ${}", ra, rb),
            Self::SETUPVAL(ra, rb) => write!(f, "SETUPVAL\t${} ${}", ra, rb),
            Self::GETTABUP(ra, rb, rc) => write!(f, "GETTABUP\t${} ${} ${}", ra, rb, rc),
            Self::GETI(ra, rb, rc) => write!(f, "GETI\t${} ${} #{}", ra, rb, rc),
            Self::GETFIELD(ra, rb, rc) => write!(f, "GETFIELD\t${} ${} ${}", ra, rb, rc),
            Self::GETTABLE(ra, rb, rc) => write!(f, "GETTABLE\t${} ${} ${}", ra, rb, rc),
            Self::TBC(ra) => write!(f, "TBC\t${}", ra),
            Self::CLOSE(ra) => write!(f, "CLOSE\t${}", ra),
            Self::FORPREP(ra, rb) => write!(f, "FORPREP\t${} #{}", ra, rb),
            Self::TFORPREP(ra, rb) => write!(f, "TFORPREP\t${} #{}", ra, rb),
            Self::TFORCALL(ra, rc) => write!(f, "TFORCALL\t${} #{}", ra, rc),
            Self::FORLOOP(ra, rb) => write!(f, "FORLOOP\t${} #{}", ra, rb),
            Self::TFORLOOP(ra, rb) => write!(f, "TFORLOOP\t${} #{}", ra, rb),
        }
    }
}
